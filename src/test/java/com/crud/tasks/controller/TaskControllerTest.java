...
public class TaskControllerTest {
    ...
    public void shouldGetTask() throws Exception {
        ...
        //When & Then
        mockMvc.perform(get("/v1/tasks/taskId?taskId=1").contentType(MediaType.APPLICATION_JSON))
    ...
    public void shouldDeleteTask() throws Exception {
        //Given
        //When & Then
        mockMvc.perform(delete("/v1/tasks/taskId?taskId=1").contentType(MediaType.APPLICATION_JSON))
                .andExpect(status().isOk());
    }
