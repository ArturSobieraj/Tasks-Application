...
public class TrelloFacadeTest {
    ...
    public void shouldCreateCard() {
        //Given
        TrelloCard trelloCard = new TrelloCard("testCard", "test1", "test2", "1");
        TrelloCardDto trelloCardDto = new TrelloCardDto("testCard", "test1", "test2", "1");
        ...
        Assert.assertEquals("1", resultCard.getId());
        Assert.assertEquals("test", resultCard.getName());
        Assert.assertEquals("testURL", resultCard.getShortUrl());
    }
}
